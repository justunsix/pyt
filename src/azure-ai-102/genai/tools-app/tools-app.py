...
def main():
    ...
    try:
        ...
        while True:
            ...
            # Catch known error during reaching a rate limit and wait before next prompt
            except RateLimitError:
                print("Rate limit reached (429). Retrying your query in 1 minute")
                print("Waiting...")
                time.sleep(30)
                print("Waited for: 30 seconds")
                time.sleep(20)
                print("Waited for: 50 seconds")
                continue
